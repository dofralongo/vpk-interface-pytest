...
@allure.epic("百迈接口测试")
@allure.feature("账户信息")
class TestAllaccountsroles:

    @allure.story("获取全部账户、角色信息")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_AllAccountsRoles(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_AllAccountsRoles.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
