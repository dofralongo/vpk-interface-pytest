...
case_id = ['change_password_01', 'change_password_02', 'change_password_03', 'change_password_04']
...
class TestChangepassword:
    ...
    def test_ChangePassword(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_ChangePassword.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
