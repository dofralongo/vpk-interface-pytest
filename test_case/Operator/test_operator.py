...
case_id = ['select_operator_01', 'select_operator_02', 'select_operator_04']
...
class TestOperator:
    ...
    def test_operator(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_operator.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
