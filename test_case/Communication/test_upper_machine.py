...
@allure.epic("百迈接口测试")
@allure.feature("上位机")
class TestUpperMachine:

    @allure.story("获取上位机信息")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_upper_machine(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_upper_machine.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
