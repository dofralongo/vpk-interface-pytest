...
case_id = ['plc_monitor_01', 'plc_monitor_02', 'plc_monitor_03', 'plc_monitor_04', 'plc_monitor_05']
...
@allure.epic("百迈接口测试")
@allure.feature("通信监控")
class TestPlcMonitor:

    @allure.story("获取PLC内容监视信息")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_plc_monitor(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_plc_monitor.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
