...
@allure.epic("百迈接口测试")
@allure.feature("指令管理")
class TestInstrunction:

    @allure.story("获取指令标签信息")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_instrunction(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_instrunction.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
