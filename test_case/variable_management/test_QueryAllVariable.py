...
class TestQueryallvariable:

    @allure.story("查询变量功能测试")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_QueryAllVariable(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_QueryAllVariable.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
