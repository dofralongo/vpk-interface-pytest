...
case_id = ['query_variable_type_01']
...
class TestQueryvariabletype:
    ...
    @allure.story("查询变量类型功能测试")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_QueryVariableType(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_QueryVariableType.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
