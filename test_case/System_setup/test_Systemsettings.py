...
class TestSystemsettings:
    ...
    def test_Systemsettings(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_Systemsettings.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
