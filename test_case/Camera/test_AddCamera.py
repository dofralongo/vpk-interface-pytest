...
case_id = ['AddCamera_01', 'AddCamera_02']
...
class TestAddcamera:
    ...
    @allure.story("添加相机功能测试")
    @pytest.mark.parametrize('in_data', eval(re_data), ids=[i['detail'] for i in TestData])
    def test_AddCamera(self, in_data, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_test_AddCamera.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
